...
// markdown支持
document.write('<script src="//cdn.jsdelivr.net/npm/markdown-it@11.0.0/dist/markdown-it.min.js"></script>');
  ...
  var content = `
	...
	<i class="mdui-icon material-icons icon-sort" data-sort="size" data-order="downward">expand_more</i>
	 ...
	 <div class="mdui-row"> 
	  ...
	  <div id="count" class="mdui-hidden mdui-center mdui-text-center mdui-m-b-3 mdui-typo-subheading mdui-text-color-blue-grey-500">共 <span class="number"></span> 項</div><a href="https://ani.rip/discord" target="_blank" class="mdui-btn mdui-btn-icon mdui-ripple mdui-ripple-white" mdui-tooltip="{content: 'Discord'}">
	 </div>
