...
function render_search_result_list() {
    ...
    <div id="count" class="mdui-hidden mdui-center mdui-text-center mdui-m-b-3 mdui-typo-subheading mdui-text-color-blue-grey-500">共 <span class="number"></span> 項<br>Discord：NekoChan#2851<br><a href="https://www.youtube.com/watch?v=RPoA0YwiVq4&loop=0"><img src="https://i.postimg.cc/52PqZ84M/image.png" border="1"></a><a id="back-to-top" href="#">返回頂部</a></div>
    </div>
    <div id="readme_md" class="mdui-typo" style="display:none; padding: 20px 0;"></div>`
    $('#content').html(content)
