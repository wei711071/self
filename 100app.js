...
function nav(path) {
    ...
    let search_text = model.is_search_page ? model.q || '' : '',
        ...
        <a href="//ko-fi.com/tw_neko_chan" target="_blank" class="mdui-btn mdui-btn-icon mdui-ripple mdui-ripple-white" mdui-tooltip="{content: \'Donate\'}" alt="Donate"><img src="//image.flaticon.com/icons/svg/2917/2917845.svg" width="30" height="45" >
