...
function nav(path) {
    ...
    <a href="https://ko-fi.com/s/df71b63ff4" target="_blank" class="mdui-btn mdui-btn-icon mdui-ripple mdui-ripple-white" mdui-tooltip="{content: 'Donate 請我一杯飲料~'}" alt="Donate 請我一杯飲料">
